...
class Bitcoin:
    ...
    def __init__(
        ...
        # set of indices of internal inputs which are non-Taproot
        self.non_taproot: set[int] = set()
    ...
    async def step3_verify_inputs(self) -> None:
        ...
        if self.non_taproot:
            ...
            # trust any amounts or scriptPubKeys.
