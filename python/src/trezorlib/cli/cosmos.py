...
def get_address(client: "TrezorClient", address: str, show_display: bool) -> str:
    ...
    return cosmos.get_address(client, address_n, show_display)
...
def get_public_key(client: "TrezorClient", address: str, show_display: bool) -> str:
    ...
    address_n = tools.parse_path(address)
    return cosmos.get_public_key(client, address_n, show_display).hex()
...
def sign_tx(
    ...
    """
    address_n = tools.parse_path(address)
    return cosmos.sign_tx(client, address_n, json.load(file))
